...
const QMetaObject caster::staticMetaObject = {
    { &BattleUnit::staticMetaObject, qt_meta_stringdata_caster.data,
      qt_meta_data_caster,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *caster::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_caster.stringdata0))
        return static_cast<void*>(const_cast< caster*>(this));
